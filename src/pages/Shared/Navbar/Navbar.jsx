...
const Navbar = () => {
  ...
  const navOptions = (
    <>
      ...
      <NavLink to="/structure" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active bg-green-800 text-white font-semibold px-4 py-2 rounded" : "px-4 py-2 font-medium"}>Apartment Structure</NavLink>
    </>
  );
